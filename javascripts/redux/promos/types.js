...
export const SET_IS_COPYING_TO_CONTENT_BLOCK = 'promos/SET_IS_COPYING_TO_CONTENT_BLOCK'
...
export const HIGHLIGHT_PROMO_AFTER_REDIRECT = 'promos/HIGHLIGHT_PROMO_AFTER_REDIRECT'
export const HIGHLIGHT_PROMO_AFTER_REDIRECT_COOKIE_KEY = 'HIGHLIGHT_PROMO_AFTER_REDIRECT'
export const UNSET_DATETIME        = 'promos/UNSET_DATETIME'
export const CHECK_VALID_URL       = 'promos/CHECK_VALID_URL'
